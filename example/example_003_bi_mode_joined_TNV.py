...
if __name__ == '__main__':
    ...
    data_eds.normalize()
    rec_eds = data_eds.reconstruct(norm = 'KL', regularization = 'joined_TNV', alg = 'DR', n_iter = 100, lmbd = 0.1, data_h = data_hd)

    scms.imsave(os.path.join(save_dir, '003_{}_tnv.png'.format(element)), rec_eds[0]/rec_eds[0].max())
